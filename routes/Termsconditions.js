    ...
    return (
      <Layout {...props} className="terms">
        <div className="container-fluid">
          <div>
          <h2 id="terms_header"><strong>תנאי שימוש באתר פורטל הדפוס</strong></h2>
<h3>תקנון השימוש באתר הנ"ל נכתב בלשון זכר אך האמור בו מתייחס לנשים וגברים כאחד.</h3>
<p></p>
<ol>
<li>
<h4>קדימון</h4>
<p>אתר פורטל הדפוס (להלן "האתר") הוא אתר המשתמש כאתר להזמנת טובין מעולמות הדפוס והנך מוזמן לקחת בו חלק בכפוף להסכמתך לתנאי השימוש אשר יפורטו להלן</p>
...
<li>
<h4>קניין רוחני</h4>
<p>האתר כמו גם כל המידע שבו לרבות עיצוב האתר, קוד האתר, קבצי מדיה לרבות גרפיקות, סרטונים, תמונות, טקסטים, קבצים המוצעים להורדה וכל חומר אחר אשר מוצג באתר שייכים במלואם לאתר הנ"ל ומהווים קניין רוחני בלעדי של אתר פורטל הדפוס ואין לעשות בהם שימוש ללא אישור כתוב מראש מאתר פורטל הדפוס.</p>
...
<p>צוות האתר / הנהלת האתר יעשה כל שביכולתו להגן על פרטי המשתמשים הרשומים באתר / מנויים הרשומים באתר. במקרים בהם יעלה בידיו של צד שלישי להשיג גישה למידע מוסכם בזאת כי לגולשים, משתמשים וחברים באתר לה תהה כל תביעה, טענה או דרישה כלפי צוות האתר פורטל הדפוס.</p>
</li>
<li>
<h4>גילוי נאות</h4>
