              ...
              }
              {
                ...
                <Popover
                  ...
                  <PopoverBody>
                    ...
                    <div className='continue-popover-message'>
                      {/*t('KitProduct.Continue_warning_msg')*/'נראה כי חסר קובץ באחד מהגרפיקות.'}&nbsp;
                      {
                        this.ContinueErrorProperties && this.ContinueErrorQuantity ?
                          ...
                          :
                          this.ContinueErrorProperties ? 'לחץ על "העלאת קובץ" להעלאת הקובץ החסר'/*t('KitProduct.Continue_error_edit_msg')*/ : t('KitProduct.Continue_error_quantity_msg')
                      }
                    </div>
                  </PopoverBody>
                </Popover>
